...
#获取文件名
def get_files():
    for filepath,dirnames,filenames in os.walk(r'/WdHeDisk/users/zhangnong/MJO/711_test/s2s_data/ecmf/U200/'):
...
def read_data(filename):
    path='/WdHeDisk/users/zhangnong/MJO/711_test/s2s_data/ecmf/U200/'
    new_path='/WdHeDisk/users/zhangnong/MJO/711_test/add_120_re_data/ecmf/U200/'
    ...
    #构造新的nc文件
    da_olr=netCDF4.Dataset(new_path+filename[0:8]+'_add_120redata_ecmf_u200.nc','w',format='NETCDF4')
