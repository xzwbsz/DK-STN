...
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/X_train_for7_7_35_sample.npy', train_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/Y_train_for7_7_35_sample.npy', train_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/re_Y_train_for7_7_35_sample.npy', re_train_Y)

np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/X_valid_for7_7_35_sample.npy', valid_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/Y_valid_for7_7_35_sample.npy', valid_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/re_Y_valid_for7_7_35_sample.npy', re_valid_Y)

np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/X_test_for7_7_35_sample.npy', test_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/Y_test_for7_7_35_sample.npy', test_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for7_7_35/re_Y_test_for7_7_35_sample.npy', re_test_Y)
