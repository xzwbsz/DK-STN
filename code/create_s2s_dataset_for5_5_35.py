...
def babj_create_dataset():
    ...
    for i in range(0, len(filenames) - 9):
        ...
        for j in range(0, 15, 5):
            babj_X.append(data_combine[j:j+5,:,:,:])
            babj_Y.append(babj_rmm[j+5:j+40,:])
            re_babj_Y.append(babj_re_rmm[j+5:j+40, :])
...
def ecmf_create_dataset():
    ...
    for i in range(0, len(filenames) - 9):
        ...
        for j in range(0, 4, 1):
            ecmf_X.append(data_combine[j:j+5,:,:,:])
            ecmf_Y.append(ecmf_rmm[j+5:j+40,:])
            re_ecmf_Y.append(ecmf_re_rmm[j+5:j+40, :])
...
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/X_train_for5_5_35_sample.npy', train_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/Y_train_for5_5_35_sample.npy', train_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/re_Y_train_for5_5_35_sample.npy', re_train_Y)

np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/X_valid_for5_5_35_sample.npy', valid_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/Y_valid_for5_5_35_sample.npy', valid_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/re_Y_valid_for5_5_35_sample.npy', re_valid_Y)

np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/X_test_for5_5_35_sample.npy', test_X)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/Y_test_for5_5_35_sample.npy', test_Y)
np.save('/WdHeDisk/users/zhangnong/MJO/908_test/data/s2s_dataset_for5_5_35/re_Y_test_for5_5_35_sample.npy', re_test_Y)
