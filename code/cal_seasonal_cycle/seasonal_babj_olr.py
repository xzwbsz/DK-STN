...
def cal_seasonal_cycle(filename):
    path='/WdHeDisk/users/zhangnong/MJO/711_test/add_120_re_data/babj/OLR/'
    #提取文件名的关键字
    ...
    if date_month < 7:
        ...
        for i in range(date_time,date_time_fina,10000):
            new_filename=str(i)
            date_year=i//10000
            data=netCDF4.Dataset(path+new_filename+'_add_120redata_babj_olr.nc')
        ...
        np.save('/WdHeDisk/users/zhangnong/MJO/711_test/seasonal_cycle/babj/OLR/'+save_filename+'_seasonal_cycle_olr.npy', mean_data_1)
        print("save 1 success!!!")
        np.save('/WdHeDisk/users/zhangnong/MJO/711_test/seasonal_cycle/babj/OLR/'+save_filename+'_run_seasonal_cycle_olr.npy', mean_data_2)
        ...
        save_filename=str(filename)
        save_filename=save_filename[4:8]
        np.save('/WdHeDisk/users/zhangnong/MJO/711_test/seasonal_cycle/babj/OLR/'+save_filename+'_seasonal_cycle_olr.npy', mean_data)
